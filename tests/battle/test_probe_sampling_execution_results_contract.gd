...
func run() -> Array[String]:
	...
	_assert_true(medium_source.contains('"run_count_completed"'), "warning family should persist completed run count", failures)
	_assert_true(medium_source.contains('samples.size()'), "warning family should derive completed run count from actual sample count", failures)
	_assert_true(medium_source.contains('scenario_summaries'), "warning family should persist scenario summaries", failures)
