...
func run() -> Array[String]:
	...
	_assert_true(source.contains('"fitted_from_sample_count": 50'), "sampling should persist fitted threshold sample count", failures)
	_assert_true(source.contains('"warning_threshold_source": "old_escape_hit==true"'), "sampling should persist warning threshold source", failures)
	_assert_true(source.contains('"error_threshold_source": "old_escape_hit==true"'), "sampling should persist error threshold source", failures)
