...
func run() -> Array[String]:
	...
	_assert_true(oscillation_source.contains('"fingerprint_zone_summary"'), "oscillation sample should persist threshold zone summary", failures)
	...
	_assert_true(static_source.contains('"fingerprint_zone_summary"'), "static zero deviation sample should persist threshold zone summary", failures)
