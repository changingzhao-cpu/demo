...
const ALLY_SCATTER_CENTER_X := -9.4
const ENEMY_SCATTER_CENTER_X := 9.5
const ALLY_SCATTER_WIDTH := 5.0
const ENEMY_SCATTER_WIDTH := 1.85
const ALLY_SCATTER_HEIGHT := 6.0
const ENEMY_SCATTER_HEIGHT := 3.9
const ALLY_FORWARD_PULL := 1.15
const ENEMY_FORWARD_PULL := 1.1
const MIN_ALLY_SPAWN_DISTANCE := 1.25
const MIN_ENEMY_SPAWN_DISTANCE := 0.9
const ENEMY_SWARM_FRONT_BIAS := 0.6
const ENEMY_SWARM_VERTICAL_CLUSTER := 0.68
