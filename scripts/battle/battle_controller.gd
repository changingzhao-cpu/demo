...
const ALLY_SCATTER_CENTER_X := -9.2
const ENEMY_SCATTER_CENTER_X := 9.1
const ALLY_SCATTER_WIDTH := 4.8
const ENEMY_SCATTER_WIDTH := 2.0
const ALLY_SCATTER_HEIGHT := 6.0
const ENEMY_SCATTER_HEIGHT := 4.2
const ALLY_FORWARD_PULL := 1.2
const ENEMY_FORWARD_PULL := 1.35
const MIN_ALLY_SPAWN_DISTANCE := 1.2
const MIN_ENEMY_SPAWN_DISTANCE := 0.82
const ENEMY_SWARM_FRONT_BIAS := 0.85
const ENEMY_SWARM_VERTICAL_CLUSTER := 0.72
